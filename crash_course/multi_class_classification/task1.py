...
def train_linear_classification_model(
  ...
  predict_training_input_fn = base.create_predict_input_fn(
    training_examples, training_targets, batch_size)
  predict_validation_input_fn = base.create_predict_input_fn(
    validation_examples, validation_targets, batch_size)
  training_input_fn = base.create_training_input_fn(
    training_examples, training_targets, batch_size)
